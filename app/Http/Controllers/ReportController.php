...
class ReportController extends Controller
{
    ...
    public function profitLoss(Request $request)
    {
        ...
        return view('report.profit_loss', compact('purchase', 'total_purchase', 'sale', 'total_sale', 'return', 'total_return', 'expense', 'total_expense', 'payment_recieved_number', 'payment_recieved', 'cash_payment_sale', 'cheque_payment_sale', 'gift_card_payment_sale', 'paypal_payment_sale', 'deposit_payment_sale', 'credit_card_payment_sale', 'payment_sent_number', 'payment_sent', 'cash_payment_purchase', 'cheque_payment_purchase', 'credit_card_payment_purchase', 'store_name', 'store_sale', 'store_purchase', 'store_return', 'store_expense', 'start_date', 'end_date'));
    }
    ...
    public function customerReport(Request $request)
    {
        ...
        $ezpos_payment_data = DB::table('payments')
                           ->join('sales', 'payments.sale_id', '=', 'sales.id')
                           ->where('customer_id', $customer_id)
                           ->whereDate('payments.date', '>=' , $start_date)
                           ->whereDate('payments.date', '<=' , $end_date)
