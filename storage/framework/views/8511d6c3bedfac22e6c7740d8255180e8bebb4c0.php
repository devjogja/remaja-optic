        ...
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase">
             <img class="mb-4" src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" alt="" width="200" height="200"></div>
          ...
          <div class="copyrights text-center">
            <p><?php echo e(trans('file.Developed By')); ?> <a href="http://lion-coders.com" class="external">Duban Project</a></p>
          </div>
        </div>
      </div>
    </div>
