          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><?php echo e(trans('file.revenue')); ?>
                  ...
                  <div class="count-number revenue-data"><?php echo e(number_format((float)$revenue)); ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <div class="col-md-3">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><?php echo e(trans('file.Sale Return')); ?>

                  <div class="count-number return-data"><?php echo e(number_format((float)$return)); ?></div>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><?php echo e(trans('file.Purchase Return')); ?>

                  <div class="count-number sale-data"><?php echo e(number_format((float)$purchase_return)); ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <div class="col-md-3">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><?php echo e(trans('file.profit')); ?>
                  ...
                  <div class="count-number profit-data"><?php echo e(number_format((float)$profit)); ?></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-7">
              <div class="card">
                ...
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#return-latest" role="tab" data-toggle="tab"><?php echo e(trans('file.Sale Return')); ?></a>
                  </li>
                  <li class="nav-item">
