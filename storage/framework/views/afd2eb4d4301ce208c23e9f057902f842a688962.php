...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" style="filter: brightness(0);" />
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><?php echo e(__('file.product')); ?></a>
              <ul id="product" class="collapse list-unstyled ">
                ...
                <li id="product-add-menu"><a href="<?php echo e(route('products.create')); ?>"><?php echo e(__('file.add_product')); ?></a></li>
                <?php endif; ?>
                <?php endif; ?>
                <?php if($print_barcode_permission_active): ?>
                <li id="print-barcode-menu"><a href="<?php echo e(route('product.printBarcode')); ?>"><?php echo e(__('file.print_barcode')); ?></a></li>
                <?php endif; ?>
                <?php if($adjustment_permission_active): ?>
                <li id="adjustment-list-menu"><a href="<?php echo e(route('qty_adjustment.index')); ?>"><?php echo e(trans('file.Adjustment')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <li id="adjustment-add-menu"><a href="<?php echo e(route('qty_adjustment.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Adjustment')); ?></a></li>
                <?php endif; ?>
                <?php if($stock_count_permission_active): ?>
                <li id="stock-count-menu"><a href="<?php echo e(route('stock-count.index')); ?>"><?php echo e(__('file.Stock Count')); ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php 
            ...
            <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i><?php echo e(trans('file.Purchase')); ?></a>
              <ul id="purchase" class="collapse list-unstyled ">
                <li id="purchase-list-menu"><a href="<?php echo e(route('purchase.index')); ?>"><?php echo e(trans('file.Purchase')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php 
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li id="purchase-add-menu"><a href="<?php echo e(route('purchase.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Purchase')); ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            ...
            <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><?php echo e(trans('file.Sale')); ?></a>
              <ul id="sale" class="collapse list-unstyled ">
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li id="pos-menu"><a href="<?php echo e(route('sale.pos')); ?>">POS</a></li>
                <?php endif; ?>
                <li id="sale-list-menu"><a href="<?php echo e(route('sale.index')); ?>"><?php echo e(trans('file.Sale')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <li id="gift-card-menu"><a href="<?php echo e(route('gift_cards.index')); ?>"><?php echo e(trans('file.Gift Card')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <li id="delivery-menu"><a href="<?php echo e(route('delivery.index')); ?>"><?php echo e(trans('file.Delivery')); ?> <?php echo e(trans('file.List')); ?></a></li>
              </ul>
            </li>
            <?php endif; ?>
            <?php 
            ...
            <li><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-calculator"></i><?php echo e(trans('file.Expense')); ?></a>
              <ul id="expense" class="collapse list-unstyled ">
                <li id="expense-category-menu"><a href="<?php echo e(route('expense_categories.index')); ?>"><?php echo e(trans('file.Expense Category')); ?></a></li>
                <li id="expense-menu"><a href="<?php echo e(route('expenses.index')); ?>"><?php echo e(trans('file.Expense')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php 
            ...
            <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-share"></i><?php echo e(trans('file.Transfer')); ?></a>
              <ul id="transfer" class="collapse list-unstyled ">
                <li id="transfer-list-menu"><a href="<?php echo e(route('transfers.index')); ?>"><?php echo e(trans('file.Transfer')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php 
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li id="transfer-add-menu"><a href="<?php echo e(route('transfers.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Transfer')); ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="ion-arrow-return-left"></i> <?php echo e(trans('file.return')); ?></a>
              <ul id="return" class="collapse list-unstyled ">
                ...
                ?>
                <?php if($index_permission_active): ?>
                <li id="return-sale-menu"><a href="<?php echo e(route('return-sale.index')); ?>"><?php echo e(trans('file.Sale')); ?></a></li>
                <?php endif; ?>
                <?php if($return_purchase_permission_active): ?>
                <li id="return-purchase-menu"><a href="<?php echo e(route('return-purchase.index')); ?>"><?php echo e(trans('file.Purchase')); ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><?php echo e(trans('file.People')); ?></a>
              <ul id="people" class="collapse list-unstyled ">
                ...
                ?>
                <?php if($index_permission_active): ?>
                <li id="user-list-menu"><a href="<?php echo e(route('user.index')); ?>"><?php echo e(trans('file.User')); ?> <?php echo e(trans('file.List')); ?></a></li>
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li id="user-add-menu"><a href="<?php echo e(route('user.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.User')); ?></a></li>
                <?php endif; ?>
                <?php endif; ?>
                <?php 
                ...
                ?>
                <?php if($index_permission_active): ?>
                <li id="customer-list-menu"><a href="<?php echo e(route('customer.index')); ?>"><?php echo e(trans('file.customer')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php 
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li id="customer-add-menu"><a href="<?php echo e(route('customer.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.customer')); ?></a></li>
                <?php endif; ?>
                <?php endif; ?>
                <?php 
                ...
                ?>
                <?php if($index_permission_active): ?>
                <li id="supplier-list-menu"><a href="<?php echo e(route('supplier.index')); ?>"><?php echo e(trans('file.Supplier')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php 
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li id="supplier-add-menu"><a href="<?php echo e(route('supplier.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Supplier')); ?></a></li>
                <?php endif; ?>
                <?php endif; ?>
              </ul>
            </li>
            <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-paper-outline"></i><?php echo e(trans('file.Report')); ?></a>
              <?php
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-gear-outline"></i><?php echo e(trans('file.settings')); ?></a>
              <ul id="setting" class="collapse list-unstyled ">
                ...
                <?php endif; ?>
                <li id="store-menu"><a href="<?php echo e(route('store.index')); ?>"><?php echo e(trans('file.Store')); ?></a></li>
                ...
                <?php endif; ?>
                <li id="profile-menu"><a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><?php echo e(trans('file.User')); ?> <?php echo e(trans('file.profile')); ?></a></li>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p><?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="http://lion-coders.com" class="external">Duban Project</a></p>
            </div>
          </div>
        </div>
      </footer>
