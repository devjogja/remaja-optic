...
<section>
    <div class="container-fluid">
        @if(in_array("returns-add", $all_permission))
            <a href="{{route('return-sale.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> {{trans('file.add')}} {{trans('file.return')}}</a>
        @endif
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{trans('file.Return')}} {{trans('file.Details')}}</i>
                </div>
            </div>
        </div>
