            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.update')}} {{trans('file.return')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => ['return-sale.update', $ezpos_return_data->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p><strong>{{ $ezpos_return_data->reference_no }}</strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="customer_id_hidden" value="{{ $ezpos_return_data->customer_id }}" />
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="form-control qty" name="qty[]" value="{{$product_return->qty}}" step="any" required/></td>
                                                        ...
                                                        <input type="hidden" class="sale-unit" name="sale_unit[]" value="{{$product_return->unit}}"/>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total">{{ number_format((float)$ezpos_return_data->total_price, 2, '.', '') }}</th>
                                                    <th><i class="fa fa-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_price" value="{{$ezpos_return_data->total_price}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><strong>{{trans('file.return')}} {{trans('file.Note')}}</strong></label>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="number" name="edit_qty" step="any" class="form-control">
                        </div>
                        <div class="form-group">
                            <label><strong>{{trans('file.Unit')}} {{trans('file.Discount')}}</strong></label>
                            <input type="number" name="edit_discount" step="any" class="form-control">
                        </div>
                        <div class="form-group">
                            <label><strong>{{trans('file.Unit Price')}}</strong></label>
                            <input type="number" name="edit_unit_price" step="any" class="form-control">
                        </div>
                        <?php
                            $tax_name_all[] = 'No Tax';
                            $tax_rate_all[] = 0;
...
$("table.order-list").on("click", ".edit-product", function() {
    ...
    $('input[name="edit_unit_price"]').val(product_price[rowindex].toFixed(2));
});
