                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Biller...">
                                                @foreach($ezpos_biller_list as $biller)
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('file.Order')}} {{trans('file.Discount')}}</strong>
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong>{{trans('file.Sale')}} {{trans('file.Status')}} *</strong></label>
                                ...
                                <div id="payment">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><strong>{{trans('file.Payment')}} {{trans('file.reference')}}  No</strong></label>
                                                <p><strong>{{'spr-' . date("Ymd") . '-'. date("his")}}</strong></p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><strong>{{trans('file.Amount')}}</strong></label>
                                                <input type="number" name="paid_amount" class="form-control" step="any"/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
