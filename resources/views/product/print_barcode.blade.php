                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <strong><input type="checkbox" name="name" checked /> {{trans('file.product')}} {{trans('file.name')}}</strong>&nbsp;
...
<script type="text/javascript">
    ...
    $("#submit-button").on("click", function(event) {
        ...
        $.each(qty, function(index) {
            i = 0;
            while (i < qty[index]) {
                htmltext += '<div style="margin-bottom: 22px; flex: 0 0 25%; max-width: 25%; font-size: 10pt;">';
