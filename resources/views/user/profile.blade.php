            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.update')}} {{trans('file.User')}} {{trans('file.profile')}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><strong>{{trans('file.User')}} {{trans('file.name')}} *</strong> </label>
                                    <input type="text" name="name" value="{{$ezpos_user_data->name}}" required class="form-control" />
                                    @if($errors->has('name'))
                                    <span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="{{$ezpos_user_data->email}}" required class="form-control">
                                    @if($errors->has('email'))
                                    <span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" value="{{$ezpos_user_data->phone}}" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label><strong>{{trans('file.Company Name')}}</strong> </label>
                                    <input type="text" name="company_name" value="{{$ezpos_user_data->company_name}}" class="form-control" />
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $("ul#setting #profile-menu").addClass("active");
